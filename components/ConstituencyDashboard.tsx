  ...
  return (
    <div id="my-constituency" className="w-full">
      ...
      <div className="max-w-3xl mx-auto mb-12 text-center">
        ...
        {error && <p className="text-red-500 mt-4 text-sm font-medium animate-shake">{t.constituency.notFound}</p>}
      </div>
        ...
        {isSearching ? (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Summary Card */}
              <div className="card p-8 bg-gradient-to-br from-navy to-navy-mid text-white border-none col-span-1 lg:col-span-2">
                <div className="flex flex-col md:flex-row justify-between gap-6">
                  <div>
                    ...
                    <p className="text-white/70 text-lg flex items-center gap-2">
                      <MapPin size={18} /> {activeData.state} • {activeData.type}
                    </p>
                  </div>
                  <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-md border border-white/10">
                    ...
                    <div className="text-xl font-bold flex items-center gap-2">
                      <User size={20} className="text-saffron-light" />
              ...
              <div className="card p-8 bg-white overflow-hidden relative">
                ...
                <h4 className="text-xl font-bold mb-6 flex items-center gap-2">
                  <Calendar size={20} className="text-ashoka-blue" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-2xl font-bold">{t.constituency.pastResults}</h3>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 mb-2">
                  <Briefcase size={24} className="text-india-green" />
                  <h3 className="text-2xl font-bold">{t.constituency.keyCandidates}</h3>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {activeData.candidates.map((candidate) => (
                    <div key={candidate.id} className="card p-6 hover:shadow-xl group">
                      ...
                      <div className="space-y-3 mt-6">
                        <div className="flex items-center gap-3 text-xs">
                          <GraduationCap size={14} className="text-ashoka-blue" />
                          <span className="text-text-secondary truncate">{candidate.education}</span>
                        </div>
                        <div className="flex items-center gap-3 text-xs">
                          <Briefcase size={14} className="text-saffron" />
                          <span className="text-navy font-bold">{candidate.assets} Assets</span>
                        </div>
                        <div className="flex items-center gap-3 text-xs">
                          <Scale size={14} className={`${candidate.criminalCases > 0 ? 'text-red-500' : 'text-india-green'}`} />
